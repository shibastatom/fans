...
<div class="<?= $gbo_container_width; ?> <?= $partial_padding ; ?>">
	<div 
	class="bg-primary flex shadow-lg"
	style="
	...
	>
		...
		<div class="flex-2">
			<img
				class="!h-full !w-full object-cover"
				src="https://chocolate-zebra-256559.hostingersite.com/wp-content/uploads/2026/08/png-constructor-using-phone-sticker-transparent-background-scaled.png"
				alt="placeholder"
			>
		</div>
	</div>
