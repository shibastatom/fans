...
$gbo_heading_content = $gbo['heading_content'];
$gbo_heading_content_content = $gbo_heading_content['content'];
...
switch ( $get_gbo_background_colour ) {
	...
	case 'bg-secondary-t20':
		...
		break;
	case 'st-bg-fade-secondary-1':
		$gbo_background_colour = 'st-bg-fade-secondary-1';
		break;
	...
	case 'st-bg-half-secondary':
		...
		break;
	case 'st-bg-third-primary-r':
		$gbo_background_colour = 'st-bg-third-primary-r';
		break;
	default:
		$gbo_background_colour = '';
		break;
