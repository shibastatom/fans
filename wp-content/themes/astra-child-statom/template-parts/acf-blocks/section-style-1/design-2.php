...
<div class="<?= $gbo_container_width; ?> py-12 flex flex-col">
	...
	<div class="<?= $gbo_content_left_flex; ?> flex flex-col justify-between <?= $gbo_section_image_parallax ?>">
		<?php if ( $gbo_section_image ) : ?>
			...
			>
				<div
				class=" h-full w-full"
				style="background-image: url('https://chocolate-zebra-256559.hostingersite.com/wp-content/uploads/2026/09/fancourt-pattern-large-blue-scaled.jpg');"
				>
					<img
	...
	<div class="<?= $gbo_content_right_flex; ?> flex flex-col justify-between <?= $gbo_section_image_parallax ?>">
		<?php if ( $gbo_section_image ) : ?>
			<?php if ( $gbo_image_animation == 'animation-1' ) : ?>
			<div 
			class="st-theme-border-1 overflow-hidden st-reveal"
